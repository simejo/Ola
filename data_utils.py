...
def sentence_to_token_ids(sentence, vocabulary,
  ...
  """
  print('Inside sentence_to_token_ids')
  if tokenizer:
    print('tokenizer')
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  fr_train_ids_path = train_path + (".ids%d.fr" % fr_vocabulary_size) #'X_train.txt' # (".ids%d.fr" % fr_vocabulary_size) # X_train
  en_train_ids_path = train_path + (".ids%d.en" % en_vocabulary_size) #'y_train.txt'#(".ids%d.en" % en_vocabulary_size) # y_train
